function build_top_model(v2_root)
%BUILD_TOP_MODEL Programmatically build EReg_v2.slx: plant (verbatim v1
% physics), servo & valve mechanics, PT passthrough blocks, external command
% sources, and the referenced controller model. Reproduces v1's signal names
% and logging marks so the verification/plot tooling maps 1:1.
...
lg = add_line(sv, getfield(h([sv '/servo_angle_cmd']), 'Outport'), ...
